    ...
    <div
        ...
        <Card class="relative w-full max-w-md bg-white/10 backdrop-blur-lg border-white/20 shadow-2xl">
            <CardHeader class="text-center space-y-4">
                ...
                <div class="space-y-2">
                    <CardTitle class="text-3xl font-bold text-white">Forgot Password</CardTitle>
                    <CardDescription class="text-gray-300">Enter your email and we'll send you a reset link.
                    </CardDescription>
                </div>
            </CardHeader>
